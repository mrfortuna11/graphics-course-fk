...
void Renderer::drawFrame()
{
  ...
  {
    auto [image, view, availableSem, readyForPresent] = *nextSwapchainImage;
    ...
    auto renderingDone = commandManager->submit(std::move(currentCmdBuf), std::move(availableSem), std::move(readyForPresent));
